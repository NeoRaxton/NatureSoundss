...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,SoundsAdapter.OnNoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSoundsAdapter = new SoundsAdapter(MainActivity.this,mSoundsModels,this);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerView.setAdapter(mSoundsAdapter);
